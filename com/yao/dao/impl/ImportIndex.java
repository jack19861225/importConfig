...
public class ImportIndex {
    ...
    public void importIndex(AllConfig indexObj, List<String> rs)
            throws Exception {
    ...
    public void initClusterClient(AllConfig cluster) {
        System.out.println(cluster.getCluster_name());
    ...
    private XContentBuilder getJsonObject(AllConfig indexObj, List<String> results)
            throws IOException, SQLException {
        final XContentBuilder jsonBuilder = XContentFactory.jsonBuilder();
        ...
        while (it.hasNext()) {
            ...
            jsonBuilder.field(map.get(temp), results.get(count++).split(",")[Integer.parseInt(temp)]);
